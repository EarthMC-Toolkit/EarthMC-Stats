...
const Discord = require("discord.js"),
      ...
      editRoleID = "966359842417705020",
      allowedChannels = ["966359699740061716"]
        ...
        if (args.length == 1 && args[0].toLowerCase() != "list") return sendSingleAlliance(client, message, m, args)
            ...
            if (args[0] && !devArgs.includes(args[0].toLowerCase())) {
                if (args[0].toLowerCase() == "online") {
                    var foundAlliance = await database.Nova.getAlliance(args[1]),
                        ops = await emc.Nova.Players.online(true).catch(() => {}),
                ...
                if (!fn.botDevs.includes(message.author.id) && !isEditor) return m.edit({embeds: [
                    new Discord.MessageEmbed()
                ...
                if (args[0].toLowerCase() == "create" || args[0].toLowerCase() == "new") {   
                    ...
                    database.Nova.getAlliances().then(async alliances => {
                        ...
                        if (!foundAlliance) return m.edit({embeds: [
                            ...
                            var allianceIndex = alliances.findIndex(alliance => alliance.allianceName.toLowerCase() == allianceName.toLowerCase())
                            
                            m.edit({embeds: [new Discord.MessageEmbed()
                ...
                } else if (args[0].toLowerCase() == "delete" || args[0].toLowerCase() == "disband") {
                    if (isEditor) return

                    database.Nova.getAlliances().then(async alliances => {
                        var allianceName = args[1],
                            foundAlliance = alliances.find(alliance => alliance.allianceName.toLowerCase() == allianceName.toLowerCase())
                ...
                else if (args[0].toLowerCase() == "add") { // Adding nation(s) to an alliance
                    database.Nova.getAlliances().then(async alliances => {
                        var allianceName = args[1],
                            foundAlliance = alliances.find(alliance => alliance.allianceName.toLowerCase() == allianceName.toLowerCase())
                        ...
                        if (!foundAlliance) return m.edit({embeds: [
                            ...
                            var formattedArgs = argsHelper(args, 2),
                            ...
                            database.Nova.getNations().then(async nations => {
                                var nationsSkipped = [], nationsAdded = []
                    ...
                    database.Nova.getAlliances().then(async alliances => {
                        ...
                        if (!foundAlliance) {
                            ...
                            for (let i = 0; i < nationsToRemove.length; i++) {
                                var currentNationToRemove = nationsToRemove[i]
                                ...
                                var foundNation = foundAlliance.nations.find(nation => nation.toLowerCase() == currentNationToRemove.toLowerCase()),
                    ...
                    if (!args[1]) {
                        ...
                        database.Nova.getAlliances().then(async alliances => {
                            ...
                            var desc = type == 'sub' ? "The alliance is now a sub-meganation. :partying_face: " 
                    ...
                    database.Nova.getAlliances().then(async alliances => {
                        ...
                        if (!foundAlliance) return m.edit({embeds: [
                            ...
                            for (let i = 0; i < len; i++) {
                                ...
                                var foundMergeAlliance = alliances.find(alliance => alliance.allianceName.toLowerCase() == allianceToMerge.toLowerCase())
