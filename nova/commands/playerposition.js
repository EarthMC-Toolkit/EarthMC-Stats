...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (args[0].toLowerCase() != "live") {
            ...
            const liveLocationEmbed = new Discord.MessageEmbed()
            ...
            async function livePosFunc() { 
                ...
                if (foundPlayerNew.world != "-some-other-bogus-world-") {
                    ...
                    liveLocationEmbed.setDescription("Live Location: \nX: " + foundPlayerNew.x + "\nY: " + (foundPlayerNew.y - 1) + "\nZ: " + foundPlayerNew.z + 
                                                    "\n\nDynmap Link: " + "[" + foundPlayerNew.x + ", " + foundPlayerNew.z + "]" + "(https://earthmc.net/map/nova/?worldname=earth&mapname=flat&zoom=7&x=" + foundPlayerNew.x + "&y=64&z=" + foundPlayerNew.z + ")")                     
                ...
                if (!timedOut) {
                    ...
                    if (!lastValidLocation) 
                        ...
                        return m.edit({embeds: [
                            ...
                            .setDescription("Last Known Location: \nX: " + lastValidLocation.x + "\nY: " + (lastValidLocation.y - 1) + "\nZ: " + lastValidLocation.z + 
                                            "\n\nDynmap Link: " + "[" + lastValidLocation.x + ", " + lastValidLocation.z + "]" + "(https://earthmc.net/map/nova/?worldname=earth&mapname=flat&zoom=7&x=" + lastValidLocation.x + "&y=64&z=" + lastValidLocation.z + ")")
                            .setColor("DARK_VIVID_PINK")
                            .setTimestamp()
                        ]}).catch(() => {})
                    }
