...
export default {
    ...
    run: async (client: Client, message: Message, args: string[]) => {
        ...
        if (!townyData) return m.edit({embeds: [ new Discord.EmbedBuilder()
            .setTimestamp()
            .setColor(Discord.Colors.Red)
        ...
        if (args[0].toLowerCase() != "live") {
            ...
            const liveLocationEmbed = new Discord.EmbedBuilder()
            ...
            async function livePosFunc() { 
                ...
                if (!foundPlayerNew) return m.edit({embeds: [new Discord.EmbedBuilder()
                    .setTitle("Error fetching player")
                ...
                if (!timedOut) {
                    ...
                    if (!lastValidLocation) return m.edit({embeds: [new Discord.EmbedBuilder()
